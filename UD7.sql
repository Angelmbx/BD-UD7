...
## Iniciamos transaccion y creamos el primer savepoint 
START TRANSACTION;
savepoint inicial;
...
## Saltará un error por hacer null un campo no 'nullable'.
## Volvemos al punto inicial (primer savepoint)

rollback to inicial;
Select * from comarcasgalicia;

## Volvemos a introducir los datos ahora sin errores.
...
##Creamos segundo savepoint
                
savepoint savepoint2; 
select * from comarcasgalicia;


## Volvemos a provocar un error haciendo null un campo no 'nullable'
...
# Vuelta al savepoint2 tras error en insert
...
##Introducimos los datos correctamente y guardamos el tercer savepoint                
savepoint savepoint3;                
select * from comarcasgalicia;

## Provocamos otro error tras el tercer savepoint estableciendo null un campo no 'nullable'
INSERT INTO Comarcasgalicia
		VALUES
                ( 140, null, 12 ),
                ( 141, 'Verín', 12 ),
...
## Volvemos al savepoint3 e introducimos los datos correctamente.                
